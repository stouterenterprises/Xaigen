...
- `/admin/model_edit.php` now includes a "Use shared provider URL + key" option and shared credential status hints so individual xAI/OpenRouter model pages can explicitly inherit provider settings from `/admin/keys.php`.
